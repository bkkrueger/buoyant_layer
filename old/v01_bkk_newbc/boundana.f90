...
SUBROUTINE xouter_ana
  ...
  do k = ku1, ku2
     do j = ju1, ju2
        uin(1,iu2-2:iu2,j,k,1) = dens
        uin(1,iu2-2:iu2,j,k,2) = dens * velx
        uin(1,iu2-2:iu2,j,k,3) = 0.0d0
        uin(1,iu2-2:iu2,j,k,4) = 0.0d0
        uin(1,iu2-2:iu2,j,k,5) = ener
        uin(1,iu2-2:iu2,j,k,6) = 0.0d0
        uin(1,iu2-2:iu2,j,k,7) = 0.0d0
        uin(1,iu2-2:iu2,j,k,8) = 0.0d0
     end do
  end do

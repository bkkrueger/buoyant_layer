...
#     endif
   ...
   subroutine Broyden_update (dss, dff, J)
      ...
      ! =======================================================================
      ! Use Broyden's method to update the Jacobian

      call matvec(uu, J, dss)
      call axpy(vv, -1.0d0, uu, dff)
      call inner_product(denom, dss, dss)
      denom = 1.0d0 / denom
      vv(:) = vv(:) * denom
      call outer_product(M, vv, dss)
